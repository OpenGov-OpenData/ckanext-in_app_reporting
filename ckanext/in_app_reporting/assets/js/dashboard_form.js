    ...
    return {
        ...
        onSelectOption: function(entity_id) {
            ...
            if (this.embeddable_list.includes(option.id)) {
                ...
                globalThis.dashboardId = option.id;
                $('#publish-warning').html("<b>Warning:</b> This dashboard is currently not published. It will be published automatically when you save this resource view.");
...
$(document).ready(function () {
    ...
    $addButton.on('click', function (event) {
        var dashboardId = globalThis.dashboardId;
        if (dashboardId !== null) {
